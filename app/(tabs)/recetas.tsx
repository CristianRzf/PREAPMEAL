        ...
        <View style={{ flex: 1 }}>
          {loadingMisRecetas ? (
            ...
            <View style={styles.centered}>
              ...
              <Text style={styles.emptySubtitle}>Publica tu primera receta</Text>
              <TouchableOpacity style={styles.emptyBtn} onPress={() => { resetForm(); setModalSubir(true); }}>
                <Text style={styles.emptyBtnText}>+ Publicar receta</Text>
              </TouchableOpacity>
            </View>
          ...
          <ScrollView contentContainerStyle={styles.modalBody} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.row2}>
              <View style={{ flex: 1 }}>
                ...
                <TextInput style={styles.input} value={formCals} onChangeText={setFormCals} placeholder="kcal" keyboardType="numeric" placeholderTextColor={COLORS.textMuted} />
              </View>
              <View style={{ flex: 1 }}>
                <Text style={styles.fieldLabel}>Tiempo (min)</Text>
                <TextInput style={styles.input} value={formTiempo} onChangeText={setFormTiempo} placeholder="min" keyboardType="numeric" placeholderTextColor={COLORS.textMuted} />
              </View>
            </View>
